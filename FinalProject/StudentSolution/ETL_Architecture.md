...
## Overview
The pipeline moves data from smart meters to analytics-ready storage using a **serverless approach**. Data processing triggers automatically when new files arrive.
